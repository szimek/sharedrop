(function(f){function m(a){var c=a.code,b=a.name;Object.defineProperty(this,"code",{set:function(a){c=a},get:function(){return c}});Object.defineProperty(this,"name",{set:function(a){b=a},get:function(){return b}})}function q(a,c){var b=c;c[0]!=g&&(b=a,b=a!=g?b+(g+c):b+c);for(var b=b.split(g),d=0;d<b.length;++d)".."==b[d]&&(b[d-1]="",b[d]="");b=b.filter(function(a){return a}).join(g);b[0]!=g&&(b=g+b);b=b.replace(/\.\//g,g);b=b.replace(/\/\//g,g);b=b.replace(/\/\./g,g);b[b.length-1]==g&&b!=g&&(b=b.substring(0,
b.length-1));return b}function r(a){var c=null;this.size=a.size||0;this.name=a.name||"";this.type=a.type||"";this.lastModifiedDate=a.lastModifiedDate||null;Object.defineProperty(this,"blob_",{enumerable:!0,get:function(){return c},set:function(a){c=a;this.size=c.size;this.name=c.name;this.type=c.type;this.lastModifiedDate=c.lastModifiedDate}.bind(this)})}function x(a){if(!a)throw Error("Expected fileEntry argument to write.");var c=0,b=a.file_?a.file_.blob_:null;Object.defineProperty(this,"position",
