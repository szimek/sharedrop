...
ShareDrop is a web application inspired by Apple's [AirDrop](http://support.apple.com/kb/ht4783) service. It allows you to transfer files directly between devices, without having to upload them to any server first. It uses [WebRTC](http://www.webrtc.org) for secure peer-to-peer file transfer and [Firebase](https://www.firebase.com) for presence management and WebRTC signaling.
...
The main difference between ShareDrop and AirDrop is that ShareDrop requires an Internet or mobile connection to discover other devices, while AirDrop doesn't need one, as it creates ad-hoc wireless network between them. On the other hand, ShareDrop allows you to share files between mobile (Android and iOS) and desktop devices and even between networks.

### Supported browsers
*   All Chromium-based browsers based on Chromium 28+ (Chrome, the new Microsoft Edge, Opera, Brave, etc.)
*   Firefox 22+
*   Safari 13+
